package com.nandy.S06SpringJdbc.dao.impl;
...
import com.nandy.S06SpringJdbc.dao.EmployeeDAO;
import com.nandy.S06SpringJdbc.dao.rowmapper.EmployeeRowMapper;
import com.nandy.S06SpringJdbc.dto.Employee;

@Component(value="employeedao")
//here internally bean name is employeeDAOImpl so we give that name in getbean parameter
